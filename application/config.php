...
return  [
	...
	// | 系统数据加密设置
	// +----------------------------------------------------------------------
	'data_auth_key' => 'lY,:|_6h>bL[0U-!4yD7a&ef<C#95cIjRXg%qM`d', //默认数据加密KEY
	'data_cache_key'=> 'lY,:|_6h>bL[0U-!4yD7a&ef<C#95cIjRXg%qM`d',
    // +----------------------------------------------------------------------
    // | UCenter客户端配置
    // +----------------------------------------------------------------------
    'uc_app_id'   => 1,   //应用ID
    'uc_api_type' =>'Model',    //可选值 Model / Service
    'uc_auth_key' =>'lY,:|_6h>bL[0U-!4yD7a&ef<C#95cIjRXg%qM`d', //加密KEY
