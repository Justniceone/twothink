<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:75:"E:\www\twothink\public/../application/admin/view/default/property\edit.html";i:1506685077;s:73:"E:\www\twothink\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<form action="<?php echo url(); ?>" method="post" class="form-horizontal">
    ...
    <div class="form-item">
        <label class="item-label">详细描述<span class="detail"></span></label>
        <div class="controls">
            <textarea name="detail" class="textarea input-large"><?php echo (isset($info['detail']) && ($info['detail'] !== '')?$info['detail']:''); ?></textarea>
        </div>
    </div>
    <div class="form-item">
